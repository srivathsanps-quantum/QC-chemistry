...
print('H4-AVQE-200k shots - Powell')
def adaptvqe(adapt_it = 4, e_th=1e-12):
    ash_excitation = []
    energies = []
    excitations= []
    #Calculation of HF state
    dev = qml.device("default.qubit", wires=qubits, shots = 200000)
    @qml.qnode(dev)
...
for k in range(n_calc):
  ...
  print(f'The final energies at iteration: {k} and the energies are {energies}')